...
FEATURE_SPEC_VERSION = "training_feature_spec_v2"
FEATURE_COLUMNS = [
    "combined_ret_1",
    "combined_ret_4",
    "combined_ret_16",
...
FEATURE_DEFINITIONS = [
    ...
    FeatureDefinition("is_synthetic", "source", "Current row source flag for synthetic normalized external data."),
    ...
    FeatureDefinition("external_ret_1", "raw_external", "Selected external-source close return over 1 bar."),
    FeatureDefinition("external_ret_4", "raw_external", "Selected external-source close return over 4 bars."),
    FeatureDefinition("external_ret_16", "raw_external", "Selected external-source close return over 16 bars."),
    FeatureDefinition("external_vol_1", "raw_external", "Selected external-source absolute 1-bar return."),
    FeatureDefinition("external_vol_4", "raw_external", "Selected external-source return volatility over 4 bars."),
    FeatureDefinition("external_vol_16", "raw_external", "Selected external-source return volatility over 16 bars."),
    ...
    FeatureDefinition("basis_level", "basis", "Observed NDAX/external close basis ratio."),
    FeatureDefinition("basis_zscore_96", "basis", "Basis z-score over 96 bars."),
    FeatureDefinition("external_ctx_available", "availability", "Selected external-source context available at current bar."),
